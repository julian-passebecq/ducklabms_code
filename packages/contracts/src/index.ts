...
export interface DuckLakeMaintenanceResult {schema_version:1;action:'merge_adjacent_files';asset:string;truth:'real local DuckLake maintenance';logical_rows_before:number;logical_rows_after:number;logical_version_changed:false;before:AssetStorageEvidence;after:AssetStorageEvidence;operations:Array<Record<string,unknown>>;claim:string}
