...
import type {Asset,Capabilities,CaseStudy,DuckLakeMaintenanceResult,ExecuteRequest,Execution,ModuleManifest,Profile,RuntimeClient,WorkflowResult,Workspace,ExerciseDefinition,ExerciseRequest,ExerciseResult,ExerciseAttempt,PracticeReview,PracticeProgress} from '../../../packages/contracts/src/index.ts';
...
export class ApiClient implements RuntimeClient {
 ...
 compactAdjacent=(id:string,asset:string)=>this.request<DuckLakeMaintenanceResult>(`/workspaces/${id}/catalog/maintenance/compact-adjacent`,{method:'POST',body:JSON.stringify({asset})});
