...
def create_app(data_dir: Path | None = None, token: str | None = None, *, mode=None, trusted_python=None, timeout=20.0):
    ...
    @app.post('/api/workspaces/{id}/catalog/maintenance/compact-adjacent')
    def compact_adjacent(id: str, body: DuckLakeMaintenance):
        return command(id, {'op': 'ducklake_compact', 'asset': body.asset})
